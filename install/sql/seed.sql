...
VALUES
('Confraternizacao Universal', '2026-01-01', '01-01', 1, 0, NULL, 'national', 1, 'BR', 1, NOW(), NOW()),
...
('Black Friday', '2026-11-27', '11-27', 'yearly', 'commercial', 'BR', 'Campanha de alta conversao no varejo.', 1, NOW(), NOW());
...
VALUES
('Aquecimento de Marca Q1', 'Campanha para reconhecimento e crescimento de audiencia.', 'Reconhecimento de marca', '2026-01-01', '2026-03-31', 'active', NOW(), NOW()),
('Campanha Sazonal Meio do Ano', 'Acoes estrategicas para datas comemorativas de inverno.', 'Engajamento', '2026-06-01', '2026-07-31', 'planned', NOW(), NOW());
...
VALUES
('Bastidores da sua operacao', 'Mostre um processo interno em formato story para aproximar a audiencia.', '2026-01-10', '01-10', 1, 'yearly', 3, 6, 2, 1, 'story', 'editorial', 'instagram,threads', 1, NOW(), NOW()),
('Pergunta da semana para gerar debate', 'Publique uma pergunta aberta sobre dores do publico.', '2026-02-14', '02-14', 1, 'yearly', 13, 2, 2, 1, 'pergunta', 'editorial', 'linkedin,instagram', 1, NOW(), NOW()),
('Conteudo educativo em carrossel', 'Explique um conceito-chave do seu nicho em passos simples.', '2026-03-18', '03-18', 1, 'yearly', 2, 4, 1, 1, 'carrossel', 'institutional', 'linkedin,instagram', 1, NOW(), NOW()),
('Video curto de tendencia', 'Aplique um tema em alta ao seu mercado com CTA de engajamento.', '2026-04-07', '04-07', 1, 'yearly', 4, 12, 2, NULL, 'reel', 'seasonal', 'tiktok,instagram', 1, NOW(), NOW());
